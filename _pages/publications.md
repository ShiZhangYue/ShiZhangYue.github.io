...
Journal Publication
------
1. **Shi, Z.**, Mandal, S., Harimkar, S., & Liu, C. (2022). Hybrid Data-Driven Feature Extraction-Enabled Surface Morphology Analysis in Additive Manufacturing with Laser Engineered Net Shaping. The International Journal of Advanced Manufacturing Technology. [[link]](https://doi.org/10.1007/s00170-022-09608-z)
...
5. Xiao, P., **Shi, Z.**, Liu, C., & Hagen, D. (2022). “Characteristics of Circulating Small Non-Coding RNAs in Plasma and Serum during Human Aging”, submitted.
6. **Shi, Z.**, Li, Y., & Liu, C. (2022). “Knowledge Sharing to Enhance the Performance of Anomaly Detection in Decentralized Additive Manufacturing System”, in preparation.
